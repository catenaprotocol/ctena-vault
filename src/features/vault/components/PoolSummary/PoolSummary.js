...
import { byDecimals9 } from 'features/helpers/bignumber';
  ...
  return (
    ...
    >
      <Grid container alignItems="center" style={{ paddingTop: '20px' }}>
        ...
        {pool.id != 'cakev2-ctena-bnb' &&  pool.id != 'cakev2-wctena-bnb'  &&  pool.id != 'cakev2-cbase-bnb' &&  pool.id != 'cakev2-ctena-busd' &&  pool.id != 'cakev2-cbase-busd' ?
          <ApyStats
          apy={apy}
